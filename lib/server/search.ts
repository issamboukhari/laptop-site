...
// Backward-compatible exports (callers may import these from search).
export { extractSpecCriteria, type SpecCriteria } from "./spec-criteria";
...
export async function searchModels(
  ...
  // The fused, gated candidate set feeds existing resolution. An empty set
  // lets smartSearch fall back to the full index (existing behavior) — final
  // verification (criteria + filters) always remains authoritative.
  const candidateIds = hybrid.admissibleModelIds;
